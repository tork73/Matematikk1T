...
Når du har tegnet grafen til en andregradsfunksjon, så har du sett at den har en form for symmetri. I videoen på nedem skal du få se at grafen til \(f(x)=ax^2+bx+c\) er symmetrisk om linjen 
  \( x = -\dfrac{b}{2a}  \) 
