...
Løs ulikheten $x^2-x \ge 2$ ved regning (uten digitale hjelpemidler). Sjekk svaret ved å bruke for eksempel GeoGebra. 

```

Nå skal vi se på en ulikhet hvor vi har et polynom av tredje grad. Her er et eksempel du kan tenke på før du ser videoen som gir en forklaring på hvordan den kan løses.
...
Løs ulikheten $f(x) >g(x)$.


**Løsning:**

<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/483683632?h=f6de64e07f&title=0&byline=0&portrait=0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
