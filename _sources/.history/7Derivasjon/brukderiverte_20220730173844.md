...
Oppgaven gir at omkretsen skal være lik 16. Etter at jeg har innført variablene kan det uttrykkes matematisk og vi kan finne sammenhengen mellom de to sidelengdene \[O = 4 \cdot x + 4 \cdot y = 16 \implies y = \frac{16-4 \cdot x}{4} = 4 - x\]
...
Da har vi funnet en sammenheng mellom de to sidelengdene og vi kan finne et funksjonsuttrykk for arealet av de to kvadratene \[A(x) = x^2 + y^2 = x^2 + (4 - x)^2 = x^2 + 16 - 2 \cdot 4 \cdot x + x^2 = 2x^2 -8x + 16\]
