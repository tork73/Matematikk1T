...
<br>
I videoen på forrige side så du at den gjennomsnittlige vekstfarten til en funksjon \(f\) fra \(x=a\) til \(x=b\) er lik stigningstallet til sekanten som går gjennom punktene \((a, f(a))\) og \((b, f(b))\). Bruk dette til å svare på oppgaven under.