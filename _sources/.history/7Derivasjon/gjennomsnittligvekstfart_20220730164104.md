...
Dette stemmer, fordi den gjennomsnittlige vekstfarten til en lineær funksjon er lik funksjonens stigningstall. \(f(0)=4\) forteller at skjæringspunktet med andreakse er 4, som også blir kalles konstantleddet.
```