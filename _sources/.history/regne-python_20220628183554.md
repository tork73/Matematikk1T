...
<p>Lag et program som ber brukeren om et helt tall \(n\)&nbsp; og som deretter regner ut summen av de \(n\) første oddetallene.</p>
<p>Du kan starte programmet ved å skrive n = int(input("Skriv inn et naturlig tall:" )</p>
<p>Når du har testet programmer, kan du kopiere koden du har laget inn i tekst-editoren nedenfor.&nbsp;</p>
