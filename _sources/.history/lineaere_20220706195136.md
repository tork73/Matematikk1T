...
I videoen på forrige side så du at \(a\) er stigningstallet til funksjonen \(f(x)=ax+b\). Det vil si at dersom man går 1 enhet mot høyre, så går man \(a\) enheter opp (eventuelt ned dersom \(a<0\)). 
