...
<p>Nedenfor ser du grafen til funksjonen \(f(x)=a\cdot k^x\). Undersøk hvordan tallene \(a\) og \(k\) påvirker grafens plassering og form ved å teste ut ulike verdier for \(a\) og \(k\) for ulike plasseringer av punktene \(A\) og \(B\). &nbsp;</p>
<p><iframe scrolling="no" src="https://www.geogebratube.org/material/iframe/id/gqahvt9h/width/793/height/518/border/888888/rc/false/ai/false/sdz/false/smb/false/stb/false/stbh/true/ld/false/sri/false/at/preferhtml5" style="border: 0px;" width="793px" height="518px"> </iframe></p>
