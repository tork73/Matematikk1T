...
Nedenfor ser du grafen til funksjonen $f(x)=a\cdot k^x$. Undersøk hvordan tallene $a$ og $k$ påvirker grafens plassering og form ved å teste ut ulike verdier for $a$ og $k$ for ulike plasseringer av punktene $A$ og $B$. &nbsp;</p>
