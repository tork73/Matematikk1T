...
<p><b>Input:</b> Funksjonen \(f$, tallene \(a$, \(b$ og antall ganger vi skal halvere \(n$&nbsp;</p>
<p><b>Gjenta</b>&nbsp;\(n$ ganger:<br>&nbsp; &nbsp; \( m = \dfrac{a+b}{2} $&nbsp;<br>&nbsp; &nbsp; <b>Hvis</b> \(f(a)$ og \(f(m)$ har ulikt fortegn, lar vi \(b=m$<br>&nbsp; &nbsp; <b>Ellers</b> lar vi \( a = m $</p>
