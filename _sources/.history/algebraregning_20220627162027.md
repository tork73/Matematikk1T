...
<div style="background-color:#FDFDFF;width:100%;border:1px solid #3D2F82;padding:15px;margin:auto;">
    <h4 style="font-weight:bold;">Utfordring</h4>
    <p>Kan du vise geometrisk hvorfor den kommutative og den assosiative loven for multiplikasjon gjelder?</p>
</div><br>
...
$$ \begin{alignat*}{1}
(2xy+3x)\color{red}{(1+y)}&=(2xy+ 3x)\cdot \color{red}{1}+ (2xy+3x)\cdot \color{red}{y}\\
&=2xy+ 3x+2xy^2+3xy \\
&=5xy+2xy^2+3x
\end{alignat*}$$
