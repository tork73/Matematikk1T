...
##Hva er forskjellen på $\text{-}2^2$ og \((\text{-}2)^2\) ?</h3>
...
Denne skrivemåten brukes ikke, siden det står akkurat det samme med eller uten parenteser. I matematikken er man opptatt av å skrive så få symboler som mulig. Samtidig
