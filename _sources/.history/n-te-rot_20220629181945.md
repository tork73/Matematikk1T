...
Å ta kvadratroten av et tall svarer til å opphøye tallet i \(\frac 1 2\). Dette kommer at vi ønsker at potensregelen \( \left(a^n\right)^m=a^{n\cdot m}\) skal gjelde også når vi har eksponenter som ikke nødvendigvis er heltall.  Vi får nemlig at $$\left(a^2\right)^\frac{1}{2} = a^{2\cdot \frac{1}{2}} = a^1=a$$