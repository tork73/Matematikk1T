...
d) Dette er et fullstendig kvadrat fordi \(4x^2 + 8x + 4 = ((2x)^2 + 2 \cdot 2x \cdot 2+ 2^2) = (2x+2)^2 = 4(x+1)^2\)

e) Riktig, dette er allerede skrevet som et kvadrat med sider x.
