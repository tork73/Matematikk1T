...
Generelt definerer vi n-te-roten av et positivt tall \(a\) til å være det positive tallet \(b\) som er slik at \(b^n=a\). Det vil si at $$b=a^\frac{1}{n}  \  \text{dersom} \ b^n=a$$

I videoen på neste side vil du lære mer om dette.  
```