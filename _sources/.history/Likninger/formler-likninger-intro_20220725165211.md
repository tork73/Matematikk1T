...
```
$ x=1$ gir  V.S. $=2\cdot 1-2=0$  og  H.S. $= 10-4\cdot 1=6$ $\Rightarrow$ V.S. ≠ H.S 

$x=2$ gir V.S. $=2\cdot 2-2=2$ og H.S. $=10-4\cdot 2=2$ $\Rightarrow$ V.S = H.S 
...
Du har sett at noen likninger ikke har noen løsninger. Da sier vi at løsningsmengden er den tomme mengde. Denne løsningsmengden har fått sitt eget symbol, nemlig $\emptyset$. Hvis $x$ er den ukjente, ville vi sagt at løsningen til likningen var $x\in\emptyset$.

Hvis likningen derimot har alle reelle tall som løsningskriver vi svaret som $x\in\mathbb{R}$.