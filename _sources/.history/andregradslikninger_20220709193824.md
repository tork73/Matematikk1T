...
Likningen $a \cdot x^2+ b \cdot x + c =0 $ har løsningen

$$x=\dfrac{-b \pm \sqrt{b^2-4ac}}{2a} \ , \quad a \not=0 $$

Hvis likningen har to løsninger $x_1$ og $x_2$, så kan $f(x)=a \cdot x^2+ b \cdot x + c$ skrives som 

$$ f(x)=a(x-x_1)(x-x_2)$$

Hvis likningen $a \cdot x^2+ b \cdot x + c =0 $ har kun én løsning $x_1$, så kan $f(x)$ skrives som 

$$ f(x)= a(x-x_1)^2$$

Hvis likningen $f(x)=0$ ikke har en løsning, så kan vi ikke faktorisere $f(x)$. 