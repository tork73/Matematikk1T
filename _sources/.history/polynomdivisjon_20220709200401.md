...
Vi kan vise at dette stemmer ved å ta utgangspunkt i et polynom \(P(x)\) og utføre divisjonen \(P(x):(x-a)\). Da får vi \[P(x):(x-a)=Q(x)+\frac{r}{x-a}\] der \(r\) er resten. Det er det samme som at
