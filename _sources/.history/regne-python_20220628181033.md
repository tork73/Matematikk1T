...
<p>I filmen nedenfor får du se hvordan vi kan skrive inne ulike størrelser som vi ønsker å sette inn i en formel. Vi skal først se hva&nbsp;</p>
<p>&nbsp; &nbsp; &nbsp; \( T_n = \dfrac{n\cdot (n+1)}{2}\)&nbsp;</p>
<p>blir når \(n = 100\). Deretter skal vi regne ut verdien til \( s = v\cdot t + 0.5\cdot a \cdot t^2\) når \(v = 10\), \(t=1.5\) og \(a = -9.81\).&nbsp;</p>
<p><br></p>
