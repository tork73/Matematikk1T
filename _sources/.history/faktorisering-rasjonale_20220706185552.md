...
$$
\begin{align*}
     \frac{x}{x-2}+\frac{2x}{x-3}-&\frac{2x}{(x-2)(x-3)}  \\[6mm]
     &= \frac{x\cdot (x-3)}{(x-2)(x-3)}+\frac{2x\cdot (x-2)}{(x-2)(x-3)}-\frac{2x}{(x-2)(x-3)}\\[6mm]
     &= \frac{x^2-3x+2x^2-4x-2x}{(x-2)(x-3)} \\[6mm]
     & = \frac{3x^2-9x}{(x-2)(x-3)}\\[6mm]
     & = \frac{3x\cdot (x-3)}{(x-2)(x-3)}\\[6mm]
     & = \frac{3x}{x-2}
\end{align*}